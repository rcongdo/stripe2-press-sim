...
// Derive from the public API return type rather than importing from a private internal path
type OccConfig = Awaited<ReturnType<pdfjsLib.PDFDocumentProxy["getOptionalContentConfig"]>>;
