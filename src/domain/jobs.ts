...
const SNACK_SPOT_CHANNELS: ChannelDef[] = [
  {
    ...
    initiallyActive: true, targetDensity: 1.5,
  },
  {
    ...
    initiallyActive: true, targetDensity: 1.2,
  },
  {
    ...
    initiallyActive: true, targetDensity: 0.9,
  },
];
...
export const snackPouchJob: JobPreset = {
  ...
  initialSettings: {
    ...
    inkChannels: {
      ...
      orange: { aniloxVolume: 4.5, viscosity: 31, strength: 104, impression: 67 },
      silver: { aniloxVolume: 4.5, viscosity: 31, strength: 104, impression: 67 },
      white:  { aniloxVolume: 4.5, viscosity: 31, strength: 104, impression: 67 },
    },
    registration: {
      C:      { x: -1.4, y:  0.4 },
      M:      { x:  0.8, y: -0.6 },
